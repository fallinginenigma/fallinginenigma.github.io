...
- [x] Add Last Modified functionality (It breaks when you add it to the gemspec or the config.yml) [^1]
- [x] Have an automatic Table of Contents 
...
- [x] hello-friend-starter : [link](https://github.com/panr/gatsby-starter-hello-friend/blob/master/src/styles/header.module.css)
