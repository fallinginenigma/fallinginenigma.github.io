...
-  Engagement Effects:  This process can be modelled as an “engagement loop”
that describes how users derive value from others in a network in a step-by step process.
...
- Once Saturation hits, to add more revenue - add layers to the cake (add adjacent nextworks by targeting other markets adjacent to the core market) and for the core market - add new formats to engage. 
